...
// import { Star, Quote, ChevronLeft, ChevronRight, Heart, Scale, Building, Brain, Utensils, Check, ArrowRight, Target, Users, Clock, Award, Calendar } from "lucide-react";
...
//       {/* All Services Grid - Single Column Layout */}
...
//                 <div
//                   key={service.id}
//                   className="relative bg-gradient-to-br from-card to-card/80 rounded-3xl p-8 md:p-12 shadow-2xl animate-fade-up overflow-hidden"
...
//                             <ArrowRight className="w-5 h-5" />
//                           </button>
//                           {/* <button className="flex-1 py-3 bg-muted text-foreground font-semibold rounded-xl hover:bg-muted/80 transition-colors">
//                             Learn More
//                           </button> */}
//                         </div>
//                       </div>
